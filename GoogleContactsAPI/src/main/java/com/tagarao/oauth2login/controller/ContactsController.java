...
import com.tagarao.oauth2login.dto.UpdateContactRequest;
import com.tagarao.oauth2login.service.GoogleContactsService;
...
public class ContactsController {
    ...
    public String showContactsPage(Model model, @AuthenticationPrincipal OAuth2User user) {
        String accessToken = getAccessToken(user);
        if (accessToken == null) {
        ...
        try {
            ...
            logger.error("Error fetching contacts", e);
            model.addAttribute("error", "Could not fetch contacts.");
        }
